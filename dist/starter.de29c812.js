...
var _utilityRenderFunctions = require("./utilityRenderFunctions");
const aboutPageImage = new URL(require("227d3bb343a4fe7e"));
const renderAboutPage = ()=>{
    ...
    const heading = (0, _utilityRenderFunctions.createHeader)("h2", "About Study Night", "about_page");
    // Create and set up the subheading
    const subHeading = (0, _utilityRenderFunctions.createElement)("h3", "Flash Cards Anywhere Anytime");
    ...
    const aboutP = (0, _utilityRenderFunctions.createElement)("p", text);
    // Create and set up the image
    const aboutImage = (0, _utilityRenderFunctions.createImage)(aboutPageImage, "Child Studying");
...
},{"227d3bb343a4fe7e":"d5xES","./utilityRenderFunctions":"7Z6eA","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"d5xES":[function(require,module,exports,__globalThis) {
...
//Helper functions
var _utilityRenderFunctions = require("./utilityRenderFunctions");
const homePageImage = new URL(require("efb3482ccb9d6e24"));
//Renders home page
const renderHomePage = ()=>{
    ...
    const header = (0, _utilityRenderFunctions.createHeader)("h1", "Study Night", "home_header");
    //Creates subheader element
    const subHeading = (0, _utilityRenderFunctions.createElement)("h2", "A Digital Study Solution for the Modern World");
    //Creates elements
    const image = (0, _utilityRenderFunctions.createImage)(homePageImage, "Desk of laptops");
...
},{"efb3482ccb9d6e24":"3kqKv","./utilityRenderFunctions":"7Z6eA","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3kqKv":[function(require,module,exports,__globalThis) {
